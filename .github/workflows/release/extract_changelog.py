...
This script extracts the changelog for the given version from the CHANGELOG.md file, under the `# Changelog` section.
...
def extract_changelog(version: str):
    ...
    readme_content = _read(CHANGELOG_READ_FILE)
